...
public abstract class DecoratorTestBase
{
    ...
    public static readonly TheoryData<ServiceLifetime, ServiceLifetime?> ValidServiceDecoratorLifetimePairs = new(
    ...
    public static readonly TheoryData<ServiceLifetime, ServiceLifetime> InvalidServiceDecoratorLifetimePairs = new(
