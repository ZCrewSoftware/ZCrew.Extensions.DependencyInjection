...
public static partial class TypeFilterExtensions
{
    extension(TypeFilter filter)
    {
        ...
        /// </remarks>
        public TypeFilter NameEndsWith(string suffix, bool ignoreCase)
        {
        ...
        /// </param>
        public TypeFilter NameEndsWith(string suffix, bool ignoreCase, CultureInfo? cultureInfo)
        {
        ...
        /// </param>
        public TypeFilter NameEndsWith(string suffix, StringComparison comparisonType)
        {
